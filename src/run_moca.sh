...
torchrun \
    ...
    --future-only \
    --name ecg_moca_scratch_diagnosis_k_1_random_fixed_future_250_trial_11 \
...
torchrun \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_scratch_q_former_diagnosis_k_1_random_fixed_future_250_trial_4 \
...
torchrun \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_scratch_demographics_diagnosis_labs_random_fixed_future_250_trial_2 \
    --model ecg_moca_biogpt_scratch \
    --seed 0
...
torchrun \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_scratch_demographics_diagnosis_labs_random_fixed_future_250_trial_3 \
    --model ecg_moca_biogpt_scratch \
    --seed 0
...
# TODO: Choose LR based on previous run
export CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6'
torchrun \
    --nnodes=1 --nproc_per_node=7 --master_addr=localhost --master_port=2120 \
    -m main \
...
# 9. Scratch - QFormer - Labs - Demographics - Diagnosis - Random Cached - Fixed - Future
...
torchrun \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_scratch_q_former_demographics_diagnosis_labs_random_cached_fixed_future_250_trial_1 \
    --model ecg_moca_biogpt_scratch_q_former \
    --seed 0
...
# 3. Pre-trained Text - Diagnosis - Random - Fixed - Future
export CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6'
torchrun \
    --nnodes=1 --nproc_per_node=7 --master_addr=localhost --master_port=2120 \
    -m main \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_pretrained_diagnosis_k_1_random_fixed_future_250_trial_2 \
    --model ecg_moca_biogpt \
    --seed 0



# 4. Pre-trained Text - Diagnosis - Random - Fixed - Future - Lower Learning Rate
export CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6'
torchrun \
    --nnodes=1 --nproc_per_node=7 --master_addr=localhost --master_port=2120 \
    -m main \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_pretrained_diagnosis_k_1_random_fixed_future_250_trial_6 \
    --model ecg_moca_biogpt \
    --seed 0
...
# 6. Pre-Trained - QFormer - Diagnosis - Random - Fixed - Future
export CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6'
torchrun \
    --nnodes=1 --nproc_per_node=7 --master_addr=localhost --master_port=2120 \
    -m main \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_pretrained_q_former_diagnosis_k_1_random_fixed_future_250_trial_1 \
    --model ecg_moca_biogpt_q_former \
    --seed 0
...
# TODO: Labs, Demographics, Diagnosis
# TODO: Focal Loss


# Scratch - Labs - Demographics - Diagnosis - Random - Fixed - Future
export CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6'
torchrun \
    --nnodes=1 --nproc_per_node=7 --master_addr=localhost --master_port=2120 \
    -m main \
    ...
    --fixed-position-range \
    --future-only \
    --name ecg_moca_scratch_diagnosis_k_1_random_fixed_future_250_trial_4=1 \
    --model ecg_moca_biogpt_scratch \
    --seed 0
