...
# 9. Scratch - QFormer - Labs - Demographics - Diagnosis - ? - Fixed - Future
...
# 10. Scratch - ? - Labs - Demographics - Diagnosis - ? - Fixed - Future - Z Loss
# TODO: Choose negatives type, architecture and LR based on previous run
export CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6'
torchrun \
    --nnodes=1 --nproc_per_node=7 --master_addr=localhost --master_port=2120 \
    -m main \
