...
--pretrained='/mnt/obi0/pk621/projects/med_instruct/vision/open_clip/src/logs/ecg_moca_scratch_diagnosis_k_1_random_fixed_future_250_trial_17/checkpoints/epoch_170.pt' \
--code-column phecode \
