...
def get_open_clip_arguments():
    parser = argparse.ArgumentParser(add_help=False)
    parser.add_argument(
        "--train-data",
        type=str,
        default=None,
        help="Path to file(s) with training data. When using webdataset, multiple datasources can be combined using "
             "the `::` separator.",
    )
    parser.add_argument(
        ...
        default=None,
        help=(
            "When using multiple data sources with webdataset and sampling with replacement, this can be used to "
            "upsample specific data sources. "
    ...
    parser.add_argument("--text-decoder-lr", type=float, default=None, help="Learning rate for the text decoder")
    parser.add_argument("--beta1", type=float, default=None, help="Adam beta 1.")
    parser.add_argument("--beta2", type=float, default=None, help="Adam beta 2.")
    parser.add_argument("--eps", type=float, default=None, help="Adam epsilon.")
    parser.add_argument("--wd", type=float, default=0.2, help="Weight decay.")
    parser.add_argument("--text-decoder-wd", type=float, default=None, help="Weight decay for the text decoder")
    parser.add_argument(
