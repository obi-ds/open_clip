...
from .data_utils import (
    get_hierarchical_diagnosis_label_prediction_task,
    get_diagnosis_label_prediction_task,
    get_diagnosis_label_prediction_task_eval,
    get_hierarchical_diagnosis_label_prediction_task_eval,
    get_demographic_task,
    get_lab_task,
    get_ecg_attributes_task,
    get_instruct_tokenizer,
    get_demographic_prompt,
    get_lab_prompt,
    get_diagnosis_prompt,
    get_ecg_attributes_prompt
)
...
def get_wds_dataset_moca_instruct(
        args,
        preprocess_img,
        is_train,
        epoch=0,
    ...
    for task in args.tasks:
        if task == 'demographics':
            ...
            task_list.append(get_diagnosis_label_prediction_task(args=args))
        elif task == 'ecg_attributes':
            task_list.append(get_ecg_attributes_task(args=args))
        elif task == 'diagnosis_hierarchy':
            task_list.append(get_hierarchical_diagnosis_label_prediction_task(args=args))
        elif task == 'eval' and (args.eval_mode or eval_mode):
            task_list.append(get_diagnosis_label_prediction_task_eval(args=args))
        elif task == 'diagnosis_hierarchy_eval' and (args.eval_mode or eval_mode):
            task_list.append(get_hierarchical_diagnosis_label_prediction_task_eval(args=args))
        elif task == 'demographics_prompt' and (args.eval_mode or eval_mode):
            task_list.append(get_demographic_prompt(args=args))
        elif task == 'labs_prompt' and (args.eval_mode or eval_mode):
            task_list.append(get_lab_prompt(args=args))
        elif task == 'diagnosis_prompt' and (args.eval_mode or eval_mode):
            task_list.append(get_diagnosis_prompt(args=args))
        elif task == 'ecg_attributes_prompt' and (args.eval_mode or eval_mode):
            task_list.append(get_ecg_attributes_prompt(args=args))
        else:
...
def get_wds_dataset_moca_prompt(
        args,
        preprocess_img,
        is_train,
        epoch=0,
