...
from training.train import train_one_epoch_mae, evaluate_instruct_basic
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_one_epoch_mae(model, data, loss, epoch, optimizer, scaler, scheduler, args, tb_writer=writer)
