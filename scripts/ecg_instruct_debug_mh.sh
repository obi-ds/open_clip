...
# test runs on small dataset with diagnostics task
export CUDA_VISIBLE_DEVICES='0'
torchrun \
...
torchrun \
    ...
    --seed 0 \
    --lock-text \
    --model ecg_cnn_windowed_biogpt7
...
torchrun \
    ...
    --seed 0 \
    --lock-text \
    --model ecg_cnn_windowed_biogpt6
